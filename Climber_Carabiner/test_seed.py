...
route1 = Route(mp_id = "0", name="Big Theif", difficulty=2, image_url="http://placehold.it/200x200&text=Route", stars="2", location="Dallas", location2="Texas", lat="32.7767", lon="-96.7970", route_type="Boulder")
route2 = Route(mp_id = "1", name="Not My Momma", difficulty=2, image_url="http://placehold.it/200x200&text=Route", stars="3", location="Plano", location2="Texas", lat="33.0198", lon="-96.6989", route_type="Lead")
